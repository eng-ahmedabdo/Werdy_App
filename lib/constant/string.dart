...
abstract class TextApp {
  ...
  static const Text headerHomeScreen=Text("لحفظ وسماع الاحاديث النبويه"
  ...
  static const Text topHadithScreen=Text("ألأحاديث الاربعون",textDirection: TextDirection.rtl
    ,style: TextStyle(color: Colors.green,fontWeight: FontWeight.bold,fontSize: 30),);
  static const Text topListenScreen=Text("الأستماع للأحاديث",textDirection: TextDirection.rtl
    ,style: TextStyle(color: Colors.green,fontWeight: FontWeight.bold,fontSize: 25),);
}